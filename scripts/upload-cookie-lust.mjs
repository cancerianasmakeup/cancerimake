...
const product = {
  file: "ChatGPT Image 16 may 2026, 03_32_58 a.m..png",
  niceName: "body-splash-cookie-lust-236ml.png",
  payload: {
    name: "Body Splash Cookie Lust 236 ml",
    slug: "body-splash-cookie-lust-236ml",
    description:
      "Body Splash Cookie Lust 236 ml — una fragancia corporal gourmand y dulce de la colección Give Me Gourmand. Para mujeres libres que aman los aromas reposteros: una galletita con chips de chocolate recién horneada, transformada en estela.\n\nPirámide olfativa:\n\n- Notas de Salida: Cacao y manteca\n- Notas de Corazón: Galleta, leche y azúcar\n- Notas de Fondo: Vainilla, crema batida y sándalo\n\nCálida, envolvente y reconfortante — como entrar a una panadería un sábado a la mañana. Estela media-alta que se queda en la piel durante horas. Ideal para uso diario y planes cozy.\n\nFine Fragrance Mist de 236 ml (8 fl.oz) — formato spray práctico para llevar. Frasco con etiqueta marrón chocolate y tapón dorado, diseño elegante que también queda lindo en el tocador.",
    price: 6000,
    compare_price: 9000,
  },
};
...
async function insertProduct(p, imageUrl) {
  const body = [{
    ...
    weight_grams: 300, length_cm: 18, width_cm: 6, height_cm: 6,
    images: [imageUrl],
  }];
