...
/**
 * La home de la tienda. Vive en un componente y no en una ruta porque la
 * sirven dos: / en el deploy de una sola tienda, y /bsas en el que ademas
 * tiene el portal de entrada.
 */
